...
class DataFramePredictor:
    ...
    def model_polling(self, text):
        ...
        if nb_pred == svm_pred == rfc_pred:
            return nb_pred  # All predictions are the same
        elif nb_pred == svm_pred:
            return nb_pred  # Naive Bayes and SVM are the same
        elif nb_pred == rfc_pred:
            return nb_pred  # Naive Bayes and RFC are the same
        elif svm_pred == rfc_pred:
            return svm_pred  # SVM and RFC are the same
        else:
            return rfc_pred  # if all are different, return RFC prediction
